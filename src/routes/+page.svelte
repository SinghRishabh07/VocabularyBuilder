...
<div class="min-h-screen bg-[#0a0e17] text-gray-100 font-sans flex items-center justify-center p-6 selection:bg-blue-900 selection:text-white">
    <div class="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
        ...
        <div class="flex flex-col items-center lg:items-start text-center lg:text-left">
            <div class="w-20 h-20 bg-[#12182b] border border-gray-800/60 rounded-3xl flex items-center justify-center mb-8 shadow-lg shadow-black/20">
                <BookOpen size={40} class="text-[#3b82f6]" />
            </div>

            <h1 class="text-5xl lg:text-6xl font-bold mb-6 tracking-tight">
                Vocab<span class="text-[#3b82f6]">Vault</span>
            </h1>
            ...
            <div class="flex items-center gap-12 lg:gap-16">
                <div class="flex flex-col gap-1">
                    <span class="text-3xl font-bold text-[#3b82f6]">10K+</span>
                    <span class="text-gray-500 text-sm font-medium">Words</span>
                </div>
                <div class="flex flex-col gap-1">
                    <span class="text-3xl font-bold text-[#3b82f6]">5K+</span>
                    <span class="text-gray-500 text-sm font-medium">Users</span>
                </div>
                <div class="flex flex-col gap-1">
                    <span class="text-3xl font-bold text-[#3b82f6]">12</span>
        ...
        <div class="w-full max-w-md mx-auto lg:mx-0">
            ...
            <button class="w-full flex items-center justify-center gap-3 bg-transparent border border-gray-700 hover:bg-gray-800/50 hover:border-gray-600 text-white font-medium py-3 px-4 rounded-xl transition-all duration-200 mb-8">
            ...
            <form onsubmit={handleSignIn} class="space-y-5">
                <div>
                    ...
                    <input 
                        ...
                        class="w-full bg-transparent border border-gray-700 focus:border-[#3b82f6] focus:ring-1 focus:ring-[#3b82f6] rounded-xl px-4 py-3.5 text-white placeholder-gray-500 outline-none transition-all duration-200"
                        required
                    />
                </div>
                ...
                <div>
                    <div class="flex items-center justify-between mb-2">
                        ...
                        <a href="/" class="text-sm text-[#3b82f6] hover:text-blue-400 transition-colors">Forgot password?</a>
                    </div>
                    <div class="relative">
                        <input 
                ...
                <button 
                    type="submit" 
                    disabled={isLoading}
                    class="w-full bg-[#3b82f6] hover:bg-blue-600 disabled:bg-blue-600/50 disabled:cursor-not-allowed text-white font-medium py-3.5 px-4 rounded-xl transition-all duration-200 mt-4 flex justify-center items-center"
                >
                    {#if isLoading}
            ...
            <p class="text-center text-gray-400 mt-8 text-sm">
                Don't have an account? <a href="/" class="text-[#3b82f6] hover:text-blue-400 font-medium ml-1 transition-colors">Sign up</a>
            </p>
        </div>
    </div>
</div>